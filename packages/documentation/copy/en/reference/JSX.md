...
* [JSX](https://facebook.github.io/jsx/)
  * == embeddable XML-like syntax /
    * -- transformed into -- valid JavaScript / implementation-specific
  * history
    * SOME years ago
    * popularity raised up -- due to -- [React](https://reactjs.org/) framework
  * supported by TypeScript,
    * embedding,
    * type checking,
    * compiling directly to -> JavaScript
